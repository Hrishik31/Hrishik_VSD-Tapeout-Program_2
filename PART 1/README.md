...
- [OpenROAD Forum](https://github.com/The-OpenROAD-Project/OpenROAD/discussions)
- [Sky130 Community](https://join.skywater.tools/)
- [r/FPGA Subreddit](https://www.reddit.com/r/FPGA/)

### Related Projects
- [PicoRV32](https://github.com/YosysHQ/picorv32) - Small RISC-V CPU
- [OpenTitan](https://opentitan.org/) - Open-source secure silicon
- [PULP Platform](https://pulp-platform.org/) - Parallel Ultra-Low-Power platform
...
VSDBabySoC is built on the shoulders of giants. Special thanks to:

- **RISC-V International** - For the open ISA
- **SkyWater Technology** - For the open PDK
- **Google** - For sponsoring open silicon programs
- **eFabless** - For community silicon access
- **VSD Team** - For educational initiatives and IP cores
...
This documentation and the VSDBabySoC project follow open-source principles:
- Documentation: CC BY 4.0
- Code: Apache 2.0 / MIT (depending on component)
- PDK: Apache 2.0 (Sky130)

Please check individual component licenses for specific details.
...
- **Ask Questions**: Community forums and discussions
- **Share Your Work**: Show what you've built!

### Stay Updated
- Follow VSD courses and workshops
...
**"Every expert was once a beginner. Every complex chip started as a simple idea."**

VSDBabySoC is your starting point. The only limit is your imagination.
...
- [ ] Install required tools (Icarus Verilog, GTKWave)
...
**Built with 💙 by the open-source hardware community**
...
### Beginner (Weeks 1-2)
1. Understand SoC basics
2. Learn digital logic fundamentals
3. Study RISC-V architecture overview
4. Run first simulation

### Intermediate (Weeks 3-6)
1. Deep dive into each component
2. Write custom programs for RVMYTH
3. Modify and observe behavior
4. Understand timing concepts

### Advanced (Weeks 7-12)
1. Complete RTL synthesis
2. Physical design basics
3. Timing closure techniques
4. Mixed-signal considerations

### Expert (Months 4-6)
1. Full tape-out flow
...
### Easy Experiments
1. **Counter Output**: Make RVMYTH count and output to DAC
2. **Pattern Generator**: Create square wave, triangle wave
3. **LED Brightness**: Control via DAC output
4. **Simple Melody**: Generate audio tones

### Medium Experiments
1. **Waveform Generator**: Sine, saw, triangle waves
2. **PWM Controller**: Implement PWM in software
3. **Simple DSP**: Audio filtering basics
4. **Communication**: Simple protocol implementation

### Advanced Experiments
1. **Custom Instructions**: Extend RISC-V ISA
2. **Multi-rate System**: Different clock domains
3. **Power Management**: Dynamic frequency scaling
4. **Sensor Interface**: Real ADC-DAC chain
...
**Every great chip designer started exactly where you are.**

The knowledge is here. The tools are free. The community is waiting.

**What will you create?**

---

[![Start Learning](https://img.shields.io/badge/Start-Learning-success?style=for-the-badge)](https://github.com)
[![Join Community](https://img.shields.io/badge/Join-Community-blue?style=for-the-badge)](https://riscv.org)
[![Build Something](https://img.shields.io/badge/Build-Something-orange?style=for-the-badge)](https://efabless.com)

---

*"The best time to start learning chip design was ten years ago. The second best time is now."*
